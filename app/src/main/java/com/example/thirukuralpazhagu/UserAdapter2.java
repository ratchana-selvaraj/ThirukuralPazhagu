...
public class UserAdapter2 extends RecyclerView.Adapter<UserAdapter2.UsersAdapter> {
    private Context context;
    private List<RecycleAdapter> usermoderlist;

    public UserAdapter2( Context context, List<RecycleAdapter> usermoderlist) {
        this.usermoderlist= usermoderlist;
        this.context=context;
    }
    @NonNull
    @Override
    public UserAdapter2.UsersAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {  //get id
    ...
    @Override
    public void onBindViewHolder(@NonNull UserAdapter2.UsersAdapter holder, final int position) { //encompasses all items to be displayed in view pager
        ...
        holder.usertext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,activity_frag1.class);
