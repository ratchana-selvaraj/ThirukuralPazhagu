...
public class UserAdapter3 extends RecyclerView.Adapter<UserAdapter3.UsersAdapter> {
    private Context context;
    private List<RecycleAdapter> usermoderlist;

    public UserAdapter3( Context context, List<RecycleAdapter> usermoderlist) {
        this.usermoderlist= usermoderlist;
        this.context=context;
    }
    @NonNull
    @Override
    public UserAdapter3.UsersAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {  //get id
    ...
    @Override
    public void onBindViewHolder(@NonNull UserAdapter3.UsersAdapter holder, final int position) { //encompasses all items to be displayed in view pager
        ...
        holder.usertext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,activity_fagin1.class);
